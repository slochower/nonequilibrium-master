...
git remote set-url origin git@github.com:slochower/nonequilibrium-master.git
...
https://github.com/slochower/nonequilibrium-master/commit/$TRAVIS_COMMIT.

This commit was created by the following Travis CI build and job:
https://travis-ci.org/slochower/nonequilibrium-master/builds/$TRAVIS_BUILD_ID
https://travis-ci.org/slochower/nonequilibrium-master/jobs/$TRAVIS_JOB_ID
